...
<form name="form1" action="">
  <div class="row">
	...
	<table class="table table-sm table-bordered table-hover mymargin5">
		<thead>
			<tr>
				<td class="mycolor2" width="15%">날짜</td>
				<td class="mycolor2" width="25%">제품명</td>
				<td class="mycolor2" width="10%">단가</td>
				<td class="mycolor2" width="10%">매입수량</td>
				<td class="mycolor2" width="10%">매출수량</td>
				<td class="mycolor2" width="15%">금액</td>
				<td class="mycolor2" width="15%">비고</td>
			</tr>
		</thead>
			@foreach ($list as $row)
			<?
			...
			<tr>
				...
				<td align="right" class="mycolor3">{{ number_format($row->numi) }}</td>
				<td align="right" class="mycolor3">{{ number_format($row->numo) }}</td>
